...
/**
 * Created by long on 16/6/7.
 */
public class XMQMaterialProgressDrawable extends Drawable implements Animatable {
    ...
    // Maps to ProgressBar default style
//    private static final int CIRCLE_DIAMETER = 36;
//    private static final float CENTER_RADIUS = 5.75f; //should add up to 10 when + stroke_width
//    private static final float STROKE_WIDTH = 1.5f;

    private static final int CIRCLE_DIAMETER = 36;
    private static final float CENTER_RADIUS = 8.05f; //should add up to 10 when + stroke_width
...
//            R.color.refresh_color
    ...
    /**
     * The data of animators operating on this drawable.
     */
    ...
    public XMQMaterialProgressDrawable(Context context, View parent) {
        mParent = parent;
