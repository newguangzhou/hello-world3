...
public class Crop {
    ...
    public void start(Activity activity,Bundle bundle) {
        start(activity, REQUEST_CROP, bundle);
    }
     ...
     */
    public void start(Activity activity, int requestCode,Bundle bundle) {
        activity.startActivityForResult(getIntent(activity, bundle), requestCode);
    }
