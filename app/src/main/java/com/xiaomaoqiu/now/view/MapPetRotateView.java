...
public class MapPetRotateView extends LinearLayout {
    private String avaterUrl;
    private SimpleDraweeView avater;
    private boolean isShowed = false;

    public MapPetRotateView(Context context) {
        this(context, null);
    }

    public MapPetRotateView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public MapPetRotateView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View rootView = LayoutInflater.from(context).inflate(R.layout.map_rotate, this, true);
