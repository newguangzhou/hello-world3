 ...
 */
public class XMQMaterialHeader extends View implements PtrUIHandler {


    private XMQMaterialProgressDrawable mDrawable;
    ...
    public XMQMaterialHeader(Context context) {
        super(context);
        initView();
    }

    public XMQMaterialHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public XMQMaterialHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        mDrawable = new XMQMaterialProgressDrawable(getContext(), this);
