...
public class CircleProgressBar extends ProgressBar {
    ...
    //文字X方向偏移
    private int mProgressTextTranslationX;
    //文字Y方向偏移
    private int mProgressTextTranslationY;
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mStyle = a.getInt(R.styleable.CircleProgressBar_prostyle, LINE);
        ...
        mLineWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_line_width, DensityUtil.dip2px(getContext(), DEFAULT_LINE_WIDTH));
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_text_size, DensityUtil.dip2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_stroke_width, DensityUtil.dip2px(getContext(), DEFAULT_PROGRESS_STROKE_WIDTH));
        ...
        mProgressTextTranslationX=a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_text_translationx,0);
        mProgressTextTranslationY=a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_text_translationy,0);
